...
const About = () => (
  <section className='grid md:grid-cols-2 grid-cols-1 items-center md:w-[85vw] w-[90vw] mx-auto md:gap-0 gap-12 mt-40'>
    <div className='text-white md:w-[77%]'>
      ...
      <button className="bg-[#FF9F0D] text-white px-12 py-4 rounded-full mt-8 hover:border hover:border-[#FF9F0D] hover:bg-transparent transition-all">Read More</button>
    </div>
