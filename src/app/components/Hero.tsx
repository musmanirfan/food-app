            ...
            <div className="grid items-center md:grid-cols-2 grid-cols-1 h-full md:w-[91vw] w-[95vw]">
                <div className="flex md:gap-12 gap-5 items-center">
                    ...
                    <div className="md:w-[80%]">
                        ...
                        <button className="bg-[#FF9F0D] text-white px-12 py-4 rounded-full mt-8 hover:border hover:border-[#FF9F0D] hover:bg-transparent transition-all">See Menu</button>
                    </div>
                </div>
