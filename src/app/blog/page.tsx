                ...
                <div className='w-[100%] sm:w-[70%]'>
                    ...
                    {blogs.map(({ image, para3 }, index) => (
                        <div className='flex flex-col gap-5 mt-20' key={index}>
                            ...
                            <div
                                className="flex cursor-pointer items-center gap-1 border transition-all hover:border-[#FF9F0D] border-black whitespace-nowrap py-4 px-7 w-fit"
                                onMouseEnter={() => setIsHovered(true)}
                                onMouseLeave={() => setIsHovered(false)}
                            >
                                <PiArrowLineUpRight style={{ color: isHovered ? '#FF9F0D' : 'black' }} />
                                <span style={{ color: isHovered ? '#FF9F0D' : 'black' }}>Button Text</span>
                            </div>
                        </div>
                    ))}
